...
public class p_megatherium extends Activity implements OnClickListener {
    private static final String TAG = "MODSApp";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.p_megatherium);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.next_animal:
                ...
                Intent i = new Intent(this, p_woolymammoth.class);
                startActivity(i);
                break;
            case R.id.home:
