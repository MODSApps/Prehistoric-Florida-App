...
import org.example.sudoku.PrehistoricAnimals;
import org.example.sudoku.R;

public class p_phorusrhacidae extends Activity implements OnClickListener{
    private static final String TAG = "MODSApp";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.p_phorusrhacidae);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.next_animal:
                ...
                Intent i = new Intent(this, PrehistoricAnimals.class);
                startActivity(i);
                break;
            case R.id.home:
